...
{\begin{cvitems}
		\item
		{Use modern front-end framework build useful tools on websites.}
		\item
		{Give a talk for the tool I developed in the annual company conference.}
		\item
		{Collaborate across teams to achieve various goals.}
	\end{cvitems}
}
...
{\begin{cvitems}
		\item
		{Designed a web-based visualization platform using modern web technologies.}
	\end{cvitems}
}
%{ 
