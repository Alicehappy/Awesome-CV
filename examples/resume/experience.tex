...
%---------------------------------------------------------
  \cventry
{Front-End JavaScript Engineer (Angular)} % Job title
...
{Worked on the Venture: MoveSnap ‑ a Moving Concierge Service that helps Real Estate Agents, Brokers, and Home Builders to enhance the relationships with their clients. Developed the user interfaces for the whole suite of applications using Angular.
	...
	\begin{cvitems}
		...
		%		\item
		%{Enriched the Confluence onboarding process with updated procedures, new technical documentation, and insightful feedback}
		%		\item 
		%{Note for Summary: Displayed an insatiable appetite for learning, consistently integrating newly acquired knowledge into the daily work; Commitment to ongoing improvement is evident in the proactive application of newfound insights, fostering a dynamic and evolving work environment}
	\end{cvitems}
}
...
%---------------------------------------------------------
  \cventry
{Software Developer (Angular Web Developer)} % Job title
{DF/Net Software ULC} % Organization
